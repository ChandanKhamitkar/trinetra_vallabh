...
class RecipeInfoBottomSheet extends StatelessWidget {
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      _bulletPoints(context, ingredients, "Ingredients"),
                      SizedBox(
                        height: 10,
                      ),
                      _bulletPoints(context, recipe, "Recipe"),
                      SizedBox(
                        height: 10,
                      ),
                      _bulletPoints(context, cutlery, "Cutlery"),
                      SizedBox(
                        height: 10,
                      ),
                    ],
  ...
  Widget _bulletPoints(BuildContext context, List arrList, String title) {
    return (Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      mainAxisSize: MainAxisSize.min,
      children: [
